...
public class ProcessadorThread extends Thread{
    ...
    private void entrarRegiaoNaoCritica() {
        System.out.println("Thread ID #" + idThread + " em região não crítica");
        processar();
    }

    private void entrarRegiaoCritica() {
        System.out.println("Thread ID #" + idThread
                + " entrando em região crítica "+ (int)(Math.random()*100));
        processar();
        System.out.println("Thread ID #" + idThread + " saindo da região crítica");
    }
